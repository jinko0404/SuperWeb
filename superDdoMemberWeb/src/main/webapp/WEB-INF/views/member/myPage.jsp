...
<html>
	...
	<body>
		<h1>마이페이지</h1>
		<form action="/memberDdo/Mypage.do" method="post">
			<fieldset>
			<legend>마이페이지</legend>
				<li>
			...
			<a href="/memberDdo/modify.do?memberId=${sessionScope.memberId}">정보수정</a><br>
			<a href="/memberDdo/delete.do?memberId=${sessionScope.memberId}">회원탈퇴</a> <br>
		</form>
	</body>
</html>